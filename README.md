...
Here is how the app serves everyone involved in the exam process, using four simple roles:
 ...
 1. The Super Admin (The "System Creator")
Think of this person as the architect who builds the system's foundation.
...
Easy setup: They can create exams, set timers (e.g., 60 minutes), write instructions, and set a passing score.

                    ...
                    {exams.length > 0 ? (
                      exams.map((exam) => (
                        ...
                        >
                          ...
                          <div className="mt-2 flex justify-between items-center gap-2 text-xs text-slate-500">
                            <p>
                              <span className="font-semibold">Eaxm Code:</span>{" "}
                              {exam?.examCode}
                            </p>
                            <p>
                              <span className="font-semibold"></span>{" "}
                              {exam?.isActive ? (
                                <span className="bg-green-500 px-2 py-0.5 rounded-full text-white">
                                  Active
                                </span>
                              ) : (
                                <span className="bg-red-500 px-2 py-0.5 rounded-full text-white">
                                  Inactive
                                </span>
                              )}
                            </p>
                            ...
                            {user?.role === "admin" ? (
                              <div className="w-full grid items-center gap-2">
                                <IonButton
                                  ...
                                  fill="solid"
                                  size="small"
                                  routerLink={`/admin/view-exam-results/${exam._id}`}
                                >
                                  View Results
                                </IonButton>
                              </div>
